          ...
          <div className="relative w-full mx-auto" style={{paddingBottom: '100%'}}>
            <div className="absolute inset-0">
              ...
              >
                ...
                {roadmapData.map((item, index) => (<motion.circle
                        key={`circle-${item.id}`}
                        cx={item.position.x}
                        cy={item.position.y}
                        r="1.0"
              ...
              {roadmapData.map((item, index) => (<motion.div
                      key={item.id}
                      className="absolute"
                      style={{
                        left: `${item.position.x}%`, top: `${item.position.y}%`, transform: 'translate(-50%, -50%)',
                      }}
              ...
              >
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-1">
                    {item.tags.slice(0, 2).map((tag) => (<span
                            key={tag}
